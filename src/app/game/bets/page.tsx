...
export default async function Page() {
    ...
    const olderCelebrity = head(sortBy(celebrities?.filter((c) => c.birth), (c) => c.birth));
    ...
    return (
        <div className="flex flex-col items-center gap-8 p-4 md:p-10 h-full">
            ...
            {myBet && celebrities && (
                <>
                    <div className="flex flex-row gap-8 justify-center px-2 pt-4">
                        <div
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <span>
                                        {youngerCelebrity.birth
                                            ? `${dayjs().diff(youngerCelebrity.birth, "year")} ans`
                                            : null}
                                    </span>
                                </div>
                            )}
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <span>
                                        {olderCelebrity.birth
                                            ? `${dayjs().diff(olderCelebrity.birth, "year")} ans`
                                            : null}
                                    </span>
                                </div>
                            )}
