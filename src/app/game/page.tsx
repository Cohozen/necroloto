            ...
            {bets && (
                <div className="stats w-full justify-center stats-vertical lg:stats-horizontal bg-primary text-primary-content shadow-lg">
                    <div className="stat">
                        ...
                        <div className="stat-desc text-primary-content">18% de plus que la moyenne</div>
                    </div>
                    ...
                    <div className="stat border-t-primary-content">
                        ...
                        <div className="stat-desc text-primary-content">1er au classement</div>
                    </div>
                </div>
            )}
            {bets && bets.length > 0 ? (
                <div role="alert" className="alert shadow-lg">
                    ...
                    <div>
                        ...
                        <div className="text-xs">{"Le parie pour l'année 2024 est déjà enregistré"}</div>
                    </div>
                ...
                <div role="alert" className="alert shadow-lg">
                    ...
                    <div>
                        ...
                        <div className="text-xs">{"Vous pouvez parier dès maintenant pour l'année 2024"}</div>
                    </div>
                    <Link href="/game/bet">
